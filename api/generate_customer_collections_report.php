<?php
/**
 * API لإنشاء تقرير تحصيلات العميل
 */
...
// بناء استعلام SQL لجلب جميع تحصيلات العميل
$sql = "SELECT c.*, u.full_name as collected_by_name
        FROM collections c
...
// إذا كان المستخدم مندوب مبيعات، عرض فقط تحصيلاته لهذا العميل
...
<head>
    ...
    <title>تقرير تحصيلات العميل - <?php echo htmlspecialchars($customer['name']); ?></title>
...
<body>
    <div class="report-wrapper">
        <div class="report-header">
            <h1><i class="bi bi-person-badge me-2"></i>تقرير تحصيلات العميل</h1>
        ...
        <div class="report-content">
            ...
            <?php if (empty($collections)): ?>
                <div class="empty-state">
                    ...
                    <h4>لا توجد تحصيلات لهذا العميل</h4>
                    <p>لم يتم تسجيل أي تحصيلات للعميل <?php echo htmlspecialchars($customer['name']); ?></p>
                </div>
            <?php else: ?>
                    ...
                    <table class="table">
                        ...
                        <tfoot>
                            <tr style="background: #f8fafc; font-weight: 600;">
                                <td colspan="<?php echo ($hasCollectionNumberColumn ? 2 : 1) + ($hasStatusColumn ? 2 : 1); ?>" style="text-align: left;">الإجمالي</td>
