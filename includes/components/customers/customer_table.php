...
if (!function_exists('renderCustomerListSection')) {
    ...
    function renderCustomerListSection(array $config): void
    {
        ...
        <div class="card shadow-sm mb-4 customers-search-card">
            <div class="card-body">
                <form method="GET" action="<?php echo htmlspecialchars($formAction); ?>" class="row g-2 g-md-3 align-items-end">
                    ...
                    <nav aria-label="Page navigation" class="mt-3">
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?php echo $currentPage <= 1 ? 'disabled' : ''; ?>">
                                <a class="page-link" href="<?php echo htmlspecialchars($paginationBase . $queryGlue . 'p=' . max(1, $currentPage - 1) . buildCustomerQuerySuffix($search, $debtStatus)); ?>">
                            ...
                            if ($startPage > 1): ?>
                                <li class="page-item">
                                    <a class="page-link" href="<?php echo htmlspecialchars($paginationBase . $queryGlue . 'p=1' . buildCustomerQuerySuffix($search, $debtStatus)); ?>">1</a>
                                </li>
                                <?php if ($startPage > 2): ?>
                            ...
                            <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                                <li class="page-item <?php echo $i === $currentPage ? 'active' : ''; ?>">
                                    <a class="page-link" href="<?php echo htmlspecialchars($paginationBase . $queryGlue . 'p=' . $i . buildCustomerQuerySuffix($search, $debtStatus)); ?>"><?php echo $i; ?></a>
                                </li>
                            <?php endfor; ?>
                            ...
                            <?php if ($endPage < $totalPages): ?>
                                ...
                                <?php endif; ?>
                                <li class="page-item">
                                    <a class="page-link" href="<?php echo htmlspecialchars($paginationBase . $queryGlue . 'p=' . $totalPages . buildCustomerQuerySuffix($search, $debtStatus)); ?>"><?php echo $totalPages; ?></a>
                                </li>
                            <?php endif; ?>

                            <li class="page-item <?php echo $currentPage >= $totalPages ? 'disabled' : ''; ?>">
                                <a class="page-link" href="<?php echo htmlspecialchars($paginationBase . $queryGlue . 'p=' . min($totalPages, $currentPage + 1) . buildCustomerQuerySuffix($search, $debtStatus)); ?>">
...
if (!function_exists('buildCustomerQuerySuffix')) {
     ...
     */
    function buildCustomerQuerySuffix(string $search, string $debtStatus): string
    {
        $params = [];
        if ($search !== '') {
