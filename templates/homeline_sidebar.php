...
switch ($role) {
    case 'manager':
        $menuItems = [
            ...
            [
                'type' => 'group',
                'title' => isset($lang['management']) ? $lang['management'] : 'الإدارة',
                'icon' => 'bi-gear',
                'expanded' => true,
                'children' => [
                    [
                    ...
                    [
                        ...
                        'badge' => '<span class="badge-new">جديد</span>'
                    ],
                    [
            ...
            [
                'type' => 'group',
                'title' => isset($lang['listing']) ? $lang['listing'] : 'القوائم',
                'icon' => 'bi-list-ul',
                'expanded' => true,
                'children' => [
                    [
            ...
            [
                'type' => 'group',
                'title' => isset($lang['attendance_section']) ? $lang['attendance_section'] : 'الحضور والانصراف',
    ...
    case 'accountant':
        $menuItems = [
            ...
            [
                'type' => 'group',
                'title' => isset($lang['accounting_section']) ? $lang['accounting_section'] : 'المحاسبة',
                'icon' => 'bi-calculator',
                'expanded' => true,
                'children' => [
                    [
            ...
            [
                'type' => 'group',
                'title' => isset($lang['attendance_management']) ? $lang['attendance_management'] : 'إدارة الحضور',
                'icon' => 'bi-calendar-check',
                'expanded' => false,
                'children' => [
                    [
    ...
    case 'sales':
        $menuItems = [
            ...
            [
                'type' => 'group',
                'title' => isset($lang['sales_section']) ? $lang['sales_section'] : 'المبيعات',
                'icon' => 'bi-cart',
                'expanded' => true,
                'children' => [
                    [
    ...
    case 'production':
        $menuItems = [
            ...
            [
                'type' => 'group',
                'title' => isset($lang['production_section']) ? $lang['production_section'] : 'الإنتاج',
    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            foreach ($menuItems as $item): 
                // Check if item is a group (expandable section)
                if (isset($item['type']) && $item['type'] === 'group'): 
                    ...
                    $isExpanded = isset($item['expanded']) ? $item['expanded'] : false;
                    if ($hasActiveChild) $isExpanded = true;
            ?>
                <li class="nav-group">
                    <div class="nav-group-header <?php echo $hasActiveChild ? 'has-active' : ''; ?>" 
                         data-group-toggle>
                        <i class="bi <?php echo htmlspecialchars($item['icon']); ?>"></i>
                        <span><?php echo htmlspecialchars($item['title']); ?></span>
                        <i class="bi bi-chevron-down nav-group-arrow"></i>
                    </div>
                    <ul class="nav-group-children <?php echo $isExpanded ? 'expanded' : ''; ?>">
                        <?php if (isset($item['children'])): 
                            foreach ($item['children'] as $child): ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo isset($child['active']) && $child['active'] ? 'active' : ''; ?>" 
                                   href="<?php echo htmlspecialchars($child['url']); ?>">
                                    <i class="bi <?php echo htmlspecialchars($child['icon']); ?>"></i>
                                    <span><?php echo htmlspecialchars($child['title']); ?></span>
                                    <?php if (isset($child['badge']) && $child['badge']): ?>
                                        <?php echo $child['badge']; ?>
                                    <?php endif; ?>
                                </a>
                            </li>
                        <?php 
            ...
            <?php
                ...
                elseif (!isset($item['divider']) && !isset($item['type'])): ?>
                <li class="nav-item">
